"""
Django settings for pi_sustentabilidade project.
...
SECRET_KEY = 'django-insecure---c5gp#*(of)olqswj+2czk@96xpoxvsc4jht%q)0=v^#1f1+&'
...
ROOT_URLCONF = 'pi_sustentabilidade.urls'
...
WSGI_APPLICATION = 'pi_sustentabilidade.wsgi.application'
